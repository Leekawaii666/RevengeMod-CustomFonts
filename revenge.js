...
(() => {
  ...
  var constants, tokens, intl, intlModule, Logger, legacy_i18n, legacy_alerts, alerts, channels, links, clipboard, invites, commands, toasts, messages, NavigationStack, NavigationNative, TextStyleSheet, createStyles, Flux, FluxDispatcher, assetsRegistry, React3, ReactNative3, semver, xxhash64, nobleHashesUtils;
  ...
  var patcher2, initializeCallbacks, renderCallbacks, isAppInitialized, isAppRendered, unpatchRunApplication, unpatchCreateElement, unpatchRegisterComponent, AppLibrary;
  var init_src4 = __esm({
    "libraries/app/src/index.tsx"() {
      "use strict";
      init_async_to_generator();
      ...
      unpatchRegisterComponent = patcher2.before(ReactNative.AppRegistry, "registerComponent", () => {
        unpatchRegisterComponent();
        setImmediate(/* @__PURE__ */ _async_to_generator(function* () {
...
Your Build: ${ClientInfoModule.Version} (${ClientInfoModule.Build})`
  ...
  var init_settings2 = __esm({
    "src/plugins/settings/index.tsx"() {
      ...
      registerPlugin({
        ...
        version: "1.0.0",
        icon: "SettingsIcon",
        afterAppRender({ patcher: patcher5, cleanup, revenge: { assets: assets3, modules: modules2, ui: { settings: sui } } }) {
          setTimeout(() => {
  ...
  function _initialize() {
    ...
    _async_to_generator(function* () {
      ...
      try {
        var modules2 = yield createModulesLibrary2();
        var [{ AppLibrary: AppLibrary2 }, { AssetsLibrary: AssetsLibrary2 }, { PluginsLibrary: PluginsLibrary2, startCorePlugins: startCorePlugins2, startCorePluginsMetroModuleSubscriptions: startCorePluginsMetroModuleSubscriptions2 }, { awaitStorage: awaitStorage2 }] = yield Promise.all([
        ...
        var PreferencesLibrary = Promise.resolve().then(() => (init_src8(), src_exports6));
  ...
  HermesInternal.setPromiseRejectionTrackingHook((promise, err) => {
    if (err) setTimeout(() => {
